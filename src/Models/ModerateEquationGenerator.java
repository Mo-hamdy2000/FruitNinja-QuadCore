...
public class ModerateEquationGenerator implements EquationGenerator {
	private int screenWidth;
	private int screenHeight;
	
	public ModerateEquationGenerator(int screenWidth, int screenHeight) {
	...
	public Equation generateEquation() {
        int initialSpeed = (int) MiscUtils.rand(300, 369);
